                       ...
                       <ul class="navbar-nav mr-auto col-md-12" style="background:white;font-size:0.8em;" >
                           ...
                           <li class="nav-item col-md-4" style="align:bottom;margin-top:0.5em;">
                               <div class="col-md-6 border-light text-right" style="display:inline;margin-top:0.3em;">
                                   按价格升序：<a class="btn btn-sm btn-light" href="#" id="asc" style="text-decoration:none;color:black;border:1px solid black;"><span class="glyphicon glyphicon-sort-by-attributes"></span></a>
                               </div>
                               <div class="col-md-6 text-left" style="display:inline;">
                                   按价格降序：<a class="btn btn-sm btn-light" href="#" id="desc" style="text-decoration:none;color:black;border:1px solid black;"><span class="glyphicon glyphicon-sort-by-attributes-alt"></span></a>
                               </div>
                               <script>
                                    //升降序按钮样式控制
                                    $(function(){
